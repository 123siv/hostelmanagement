<html lang="en">
  ...
  <body>
		<header class="clearfix">
		    ...
		    <!--<nav class="clearfix">
            <ul class="clearfix">
            <li><a href="<?php echo site_url("admin/listhostel") ?>" class="">HOME</a></li>
            <li><a href="<?php echo site_url("guest/login") ?>">LOGIN</a></li>
            <li><a href="<?php echo site_url("guest/hostelregistration") ?>">REGISTER</a></li>
            <li><a href="<?php echo site_url("guest/search") ?>">SEARCH</input></a></li>
            <li><a href="<?php echo site_url("guest/advsearch") ?>">ADVANCED SEARCH</input></a></li>
